  ...
  return (
    <div className="fixed left-6 bottom-6 flex items-center justify-center overflow-hidden z-50">
      ...
      <div className="relative flex items-center justify-center w-[150px] h-[150px] rounded-full">
        ...
        <div className="absolute inset-0 flex items-center justify-center rounded-full border-[3px] border-dark">
          {/* Rotating Image */}
          <Image
            src={spinImage}
            width={185}
        ...
        <Link
          ...
          w-[60px] h-[60px] bg-dark text-light rounded-full 
          text-xs font-semibold border-2 border-solid border-dark
          shadow-lg transition-all duration-300 ease-in-out
          hover:bg-gradient-to-r hover:from-pink-400 hover:via-pink-500 hover:to-pink-400 
          hover:text-dark hover:scale-110 hover:shadow-2xl"
        >
          Hire Me
        </Link>
      </div>
