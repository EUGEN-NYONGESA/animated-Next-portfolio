...
const FeaturedArticle = ({ img, title, time, summary, link, index }) => (
  <motion.li
    ...
    whileHover="hover"
    className="col-span-12 w-full p-8 bg-light dark:bg-gray-900 border-2 border-solid border-dark/10 dark:border-gray-700 rounded-3xl shadow-xl relative overflow-hidden group"
  >
    ...
    {/* Featured badge */}
    <motion.div 
      className="absolute top-6 right-6 flex items-center gap-2 text-primary dark:text-primary font-semibold text-sm bg-primary/10 dark:bg-primary/20 px-3 py-1 rounded-full"
    ...
    <div className="flex flex-col lg:flex-row items-center gap-8 relative z-10">
      ...
      <div className="w-full lg:w-2/5">
        <Link
          href={link}
          target="_blank"
          className="w-full cursor-pointer overflow-hidden rounded-2xl border border-solid border-dark/20 dark:border-gray-600 block"
        >
          <motion.div
      ...
      {/* Text */}
      <div className="w-full lg:w-3/5 flex flex-col items-start justify-between gap-4">
        <motion.div 
          className="flex items-center gap-4 text-primary dark:text-primary font-medium text-base"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
          transition={{ delay: 0.2 }}
          viewport={{ once: true }}
        >
          <span className="flex items-center gap-2 bg-primary/10 dark:bg-primary/20 px-3 py-1 rounded-full">
        ...
        <Link
          href={link}
          target="_blank"
          className="hover:underline underline-offset-4 w-full group/title"
        >
          <motion.h2 
            className="w-full text-left text-3xl font-bold text-dark dark:text-light group-hover/title:text-primary dark:group-hover/title:text-primary transition-colors duration-300 leading-tight"
            initial={{ opacity: 0, y: 20 }}
            whileInView={{ opacity: 1, y: 0 }}
            transition={{ delay: 0.3 }}
            viewport={{ once: true }}
        ...
        <motion.p 
          className="font-medium text-dark/75 dark:text-light/75 leading-relaxed text-lg border-t border-dark/10 dark:border-light/10 pt-4 w-full"
          initial={{ opacity: 0 }}
        ...
        <motion.div 
          className="mt-4 flex items-center gap-4 border-t border-dark/10 dark:border-light/10 pt-4 w-full"
          initial={{ opacity: 0, y: 20 }}
          whileInView={{ opacity: 1, y: 0 }}
        ...
        >
          ...
          >
            <Link
              href={link}
              target="_blank"
              className="flex items-center gap-3 text-lg font-semibold text-primary dark:text-primary hover:text-primary dark:hover:text-primary transition-all duration-300 bg-primary/10 hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30 px-6 py-3 rounded-full"
            >
              Read Article 
              <motion.span
                animate={{ x: [0, 5, 0] }}
...
const Article = ({ img, title, time, summary, link, index }) => {
  ...
  return (
    <motion.article
      ...
      whileHover="hover"
      className="w-full flex flex-col items-center justify-center rounded-2xl border border-solid border-dark/10 dark:border-gray-700 bg-light dark:bg-gray-900 p-6 shadow-lg relative overflow-hidden group cursor-pointer"
    ...
    >
      ...
      <motion.div
        className="w-full cursor-pointer overflow-hidden rounded-xl border border-solid border-dark/20 dark:border-gray-600 mb-4"
        variants={imageHoverVariants}
        whileHover="hover"
      >
        <Image
      ...
      <div className="w-full flex flex-col items-start justify-between gap-3 relative z-10">
        <div className="flex items-center justify-between w-full">
          <span className="flex items-center gap-2 text-primary dark:text-primary font-medium text-sm bg-primary/10 dark:bg-primary/20 px-3 py-1 rounded-full">
          ...
          <motion.span
            ...
            className="text-dark/60 dark:text-light/60 text-sm bg-dark/5 dark:bg-light/5 p-1 rounded-full"
          >
            ▼
          </motion.span>
        </div>
        ...
        <motion.h2 
          className="w-full text-left text-xl font-bold text-dark dark:text-light leading-tight"
        ...
        <AnimatePresence>
          {isExpanded && (
            ...
            >
              <p className="text-dark/75 dark:text-light/75 text-base leading-relaxed border-t border-dark/10 dark:border-light/10 pt-3 mb-3">
                {summary}
              </p>
              <motion.div
                whileHover={{ x: 5 }}
              ...
              >
                <Link
                  href={link}
                  target="_blank"
                  className="inline-flex items-center gap-2 text-primary dark:text-primary font-semibold text-sm hover:text-primary dark:hover:text-primary transition-all duration-300 bg-primary/10 hover:bg-primary/20 dark:bg-primary/20 dark:hover:bg-primary/30 px-4 py-2 rounded-full"
        ...
        {!isExpanded && (
          ...
          >
            ...
            >
              <button
                className="inline-flex items-center gap-1 text-dark/60 dark:text-light/60 font-medium text-sm hover:text-primary dark:hover:text-primary transition-all duration-300 mt-2"
              >
                Tap to expand
              </button>
            </motion.div>
      ...
      <main className="w-full mb-16 flex flex-col items-center justify-center overflow-hidden dark:bg-dark">
        <Layout className="pt-16">
          ...
          <motion.h2
            ...
            className="inline-block w-full text-dark/75 dark:text-light/75 font-medium text-center capitalize mb-16 text-xl leading-relaxed"
          >
          ...
          <motion.ul
            ...
            className="grid grid-cols-12 gap-8 gap-y-12 mb-20"
          >
          ...
          >
            <div className="w-8 h-px bg-dark/20 dark:bg-light/20"></div>
            <motion.h3
              className="text-3xl font-bold text-center text-dark dark:text-light flex items-center gap-3"
          ...
          <motion.div
            ...
            transition={{ duration: 0.6, ease: "easeInOut" }}
            viewport={{ once: true }}
            className="text-center mt-20 p-8 bg-gradient-to-r from-primary/10 to-blue-500/10 rounded-3xl border border-primary/20"
          >
            <motion.h3 
              className="text-2xl font-bold text-dark dark:text-light mb-4"
              whileHover={{ scale: 1.05 }}
              transition={{ duration: 0.3 }}
            >
              Want more content like this?
            </motion.h3>
            <motion.p className="text-dark/75 dark:text-light/75 mb-6 text-lg">
            ...
            >
              <Link
                href="/contact"
                className="inline-flex items-center gap-3 bg-primary text-light dark:text-dark px-8 py-4 rounded-full text-lg font-semibold hover:bg-primary-dark transition-all duration-300 shadow-lg hover:shadow-xl"
              >
